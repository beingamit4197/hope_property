    ...
    <section id="properties" className="py-6 md:py-16 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-6 md:mb-12">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-2 md:mb-4 text-foreground">Featured Properties</h2>
        ...
        <div className="text-center mt-12">
          <Button size="lg" className="rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 px-8">
            View All Properties
          </Button>
        </div>
      </div>
